...
class AnonShowComments extends StatefulWidget {
  ...
  @override
  _AnonShowCommentsState createState() => _AnonShowCommentsState();
}

class _AnonShowCommentsState extends State<AnonShowComments> {
  @override
  void initState() {
    super.initState();
    if (mounted) {
