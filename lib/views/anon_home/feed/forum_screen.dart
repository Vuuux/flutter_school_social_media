...
class _ForumItemState extends State<ForumItem> {
  ...
  buildPostHeader(String uid, BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      future:
          DatabaseServices(uid: uid).ctuerRef.doc(widget.forum.ownerId).get(),
      builder: (context, snapshot) {
        ...
        return ListTile(
          ...
          title: GestureDetector(
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => ForumDetail(forumId: widget.forum.forumId, ownerId: user.id))),
            child: Text(
              user.nickname,
          ...
          subtitle: Text(timeago.format(widget.forum.timestamp.toDate())),
          trailing: IconButton(
            //TODO: DELETE FORUM
      ...
      child: Stack(
        ...
        children: <Widget>[
          ClipRRect(
              ...
              child: Image.network(widget.forum.url)),
          showHeart
              ? Animator(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
           ForumTile(forum: widget.forum, userData: widget.currentUser!),
