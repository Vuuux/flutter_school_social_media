...
class _TriviaState extends State<Trivia> {
  ...
  List<Questions> questions = [
    ...
    Questions(text: 'Nếu bạn có quyền làm mọi thứ trong 24h, bạn sẽ làm gì?'),
    Questions(text: 'Trò chơi ưa thích của bạn là gì?'),
    Questions(text: 'Xe đạp, xe máy, xe hơi hay máy bay?'),
    Questions(text: 'Bạn hát bài gì đầu tiên nếu đi Karaoke?'),
    Questions(text: 'Hai môn học phần bạn ưa thích nhất?'),
    Questions(text: 'Lần cuối bạn rơi lệ là khi nào?'),
    Questions(
        text: 'Nếu bạn có quyền chọn bạn gái, bạn sẽ chọn mẫu người thế nào?'),
    Questions(
        text:
    ...
    Questions(text: 'Vào buổi tối, bạn sẽ thích làm gì?'),
    Questions(text: 'Hà Nội hay Sài Gòn?'),
    Questions(
        text:
            'Giữa trúng số và có được một công việc hoàn hảo, bạn chọn cái nào?'),
    Questions(text: 'Nếu bạn bị lạc ra hoang đảo, bạn muốn ở cùng ai?'),
    Questions(
        text:
            'Nếu mà tiền bạc không còn là vấn đề nữa, bạn sẽ làm gì mỗi ngày?'),
    Questions(
        text:
            'Nếu mà bạn có thể du hành thời gian, bạn sẽ quay lại thời điểm nào?'),
    ...
    Questions(text: 'Bạn thích di chuyển trên loại phương tiện nào?'),
    Questions(text: 'Sở thú nào bạn từng ghé qua rồi?'),
    Questions(text: 'Bạn muốn giây phút cuối đời của bạn sẽ như thế nào?'),
    Questions(
        text:
    ...
    Questions(text: 'Lần mất ngủ lâu nhất của bạn là bao lâu?'),
    ...
    Questions(text: 'Chuyện điên nhất mà bạn từng làm trong tình cảm?'),
    Questions(text: 'Nếu bị đem ra hoang đảo, bạn sẽ đem cái gì theo?'),
    ...
    Questions(text: 'Giác quan nào của bạn mạnh nhất trong 5 giác quan?'),
    Questions(text: 'Bạn đã từng nhận được món quà bất ngờ nào chưa?'),
    ...
    Questions(text: 'Bạn có muốn gặp 1 người nổi tiếng? Và đó là ai?'),
    Questions(text: 'Ai là crush đầu tiên của bạn?'),
    Questions(text: 'Hãy tự đánh giá độ hài hước của bạn trên thang điểm 10'),
    Questions(
        text:
            'Sau 10 năm nhìn lại bản thân, bạn thấy mình thay đổi thế nào rồi?'),
    ...
    Questions(text: 'Bạn sẽ dùng con vật nào để mô tả bản thân mình?'),
  ...
  answerQuestion() {
    DatabaseServices(uid: _auth.currentUser?.uid).createTriviaRoom(
        widget.triviaRoomId,
        widget.currentUserData.username,
        widget.ctuerData.username);
